...
const total_iteraciones = 165; // Cantidad de veces que se lanzan los dardos
let cantidad_tiros = 600; // Cantidad de dardos lanzados, se aumenta n iteraciones su valor
